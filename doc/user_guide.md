...
3. Register message process callback
   ...
   3.1 This callback handles transport layer application message.
    ...
    ```C
   // The library invokes this callback once to get both IDs and payload.
   libspdm_return_t libspdm_vendor_response_func(
     ...
     void *resp_data)
   {
     // Examine request to determine response type
     // Set response IDs: *resp_standard_id, *resp_vendor_id_len, resp_vendor_id
     // Set response payload: *resp_size, resp_data
      ...
